...
class CarmOmf(object):
    ...
    def add_carm_as_external_component(self):
        ...
        PartDocPath = self.path + self.extention
        print PartDocPath
        PartDocPath1 = self.path + '\CA' + self.carm_part_number + '.CATPart'
    ...
    def copy_ref_surface_and_paste(self, size):
        ...
        selection3.visProperties.SetRealColor(210, 180, 140, 0)
        selection3.visProperties.SetRealOpacity(255, 0)
    ...
    def add_jd_annotation(self, jd_number, sta_value_pairs, size, side, capture_number):
...
class CarmUpperBin(CarmOmf):
    ...
    def add_sta_annotation(self, sta_value_pairs, sta_values_fake, size, side, capture_number):
        """Adds REF annotation"""
    ...
    def add_jd_annotation(self, jd_number, sta_value_pairs, size, side, arch, capture_number):
        """Adds JOINT DEFINITION XX annotation"""
...
class CarmLowerBin(CarmUpperBin):
    ...
    def shift_camera(self, sta_value_pairs, size=None):
        ...
        if self.side == 'LH':
            ...
            upper_downer_strap_origin = [16127.881836 + coefficient + 4000.0, 6792.799805, 9425.416016]
            ...
            lower_plenum_downer_strap_sight_direction = [0, -1, 0]
            lower_plenum_downer_strap_up_direction = [0, 0, 1]
            upper_downer_strap_sight_direction = [0, -0.888642, -0.458601]
            upper_downer_strap_up_direction = [0, -0.458601, 0.888642]
            lower_plenum_fastener_jd01_sight_direction = [0, -1, 0]
            lower_plenum_fastener_jd01_up_direction = [0, 0, 1]
            lower_plenum_fastener_jd02_sight_direction = [0, -0.726964, -0.686676]
            lower_plenum_fastener_jd02_up_direction = [0, -0.686676, 0.726964]
    ...
    def add_jd_annotation(self, jd_number, sta_value_pairs, size, side, arch, capture_number):
        ...
        captures1 = ann_set1.Captures
        capture1 = captures1.Item(capture_number)
        view_to_activate = capture1.ActiveView
        KBE.ActivateTPSView(ann_set1, view_to_activate)
...
class CarmLowerBinNonConstant(CarmLowerBin):
    ...
    def shift_camera(self, sta_value_pairs, size=None):
        ...
        if self.side == 'LH':
            ...
            upper_downer_strap_origin = [9594.720703 + coefficient, 7206.265137, 9366.074219]
            ...
            lower_plenum_downer_strap_up_direction = [0, 0, 1]
            upper_downer_strap_sight_direction = [0.080403, -0.919007, -0.385956]
            upper_downer_strap_up_direction = [0.033638, -0.384487, 0.922517]
            lower_plenum_fastener_jd01_sight_direction = [0.087156, -0.996195, 0]
            lower_plenum_fastener_jd01_up_direction = [0, 0, 1]
            lower_plenum_fastener_jd02_sight_direction = [0.063359, -0.724197, -0.686676]
            lower_plenum_fastener_jd02_up_direction = [0.059848, -0.684063, 0.726964]
